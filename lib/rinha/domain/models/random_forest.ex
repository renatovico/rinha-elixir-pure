defmodule Rinha.Domain.Models.RandomForest do
  @moduledoc """
  Pure-Elixir tree ensemble fraud scoring model.
  """
  ...
  def score(other), do: raise("RandomForest expects a 16-int query, got #{inspect(other)}")
  ...
  def probability(other), do: raise("RandomForest expects a 16-int query, got #{inspect(other)}")
